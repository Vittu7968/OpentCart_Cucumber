...
public class RegistrationSteps {
	...
	public void user_enters_the_details_into_below_fields(DataTable dataTable) {
		...
		//DataTable belongs to cucumber->io.cucumber.datatable.DataTable
		//HashMap Storing key and value pairs
		Map<String, String> dataMap = dataTable.asMap(String.class,String.class);//asMaps converts dataTable to Map
		...
		regpage.setEmail(BaseClass.randomAlphaNumeric()+"@gmail.com");//Email is unique For this scenario
